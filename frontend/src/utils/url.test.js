...
describe('getApiPath default', () => {
  it('url prefix', () => {
    const tests = [
      ...
      {input: "tools/duplicate-finder", expected: "/files/api/tools/duplicate-finder",},
      {input: "tools/file-watcher", expected: "/files/api/tools/file-watcher",},
      {input: "tools/file-watcher/sse", expected: "/files/api/tools/file-watcher/sse",},
